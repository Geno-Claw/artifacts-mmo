...
const modalState = {
  ...
  configOptions: null,
  configView: 'global',
  configFocusedCharacter: '',
  configCharacterTab: 'settings',
  configRawParseError: '',
  configRequiresRestart: false,
  configRestartReasons: [],
  configIfMatchHash: '',
  configValidationErrors: [],
  gearBlacklistBusy: false,
  gearBlacklistPendingCode: '',
  gearBlacklistPendingAction: '',
  configBusy: false,
