...
const FALLBACK_EQUIPPED_SLOTS = [
  ...
  { key: 'artifact1_slot', category: 'artifact', quantityKey: null },
  { key: 'artifact2_slot', category: 'artifact', quantityKey: null },
  { key: 'artifact3_slot', category: 'artifact', quantityKey: null },
