...
const CONFIG_EDITOR_DESCRIPTION_POINTERS = Object.freeze({
  ...
  'characters[].routines.bossFight.enabled': '#/$defs/bossFightRoutine/properties/enabled',
  'characters[].routines.bossFight.bossCode': '#/$defs/bossFightRoutine/properties/bossCode',
  'characters[].routines.bossFight.teamSize': '#/$defs/bossFightRoutine/properties/teamSize',
  'characters[].routines.bossFight.minWinrate': '#/$defs/bossFightRoutine/properties/minWinrate',
